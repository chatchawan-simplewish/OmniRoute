...
let secureConsoleOwnedTaskTabV44State = "UNADOPTED";
...
await (async () => {
  let secureConsoleV44AttachmentEvidence = null;
  let secureConsoleV44TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV44Attachment = null;
  let secureConsoleAgentV44Attachment = null;
  let secureConsoleChromeV44Attachment = null;
  let secureConsoleOwnedTaskTabV44Attachment = null;
  let secureConsoleOwnedTaskTabV44AttachmentEligible = false;
  let secureConsoleV44AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV44Consumed === false;
    secureConsoleV44Consumed = true;
    ...
    let result = "V44Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V44Attachment_PURE_TRUSTED_LISTING
    ...
    // END_V44Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV44 === null &&
        secureConsoleOwnedTaskTabV44Eligible === false &&
        secureConsoleOwnedTaskTabV44State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV44PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV44PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV44Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV44Attachment === null &&
        secureConsoleAgentV44Attachment === null && secureConsoleChromeV44Attachment === null &&
        secureConsoleOwnedTaskTabV44Attachment === null &&
        secureConsoleOwnedTaskTabV44AttachmentEligible === false &&
        secureConsoleV44AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV44AttachmentState = "V44Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV44Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV44Attachment = await secureConsoleSetupBrowserRuntimeV44Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV44Attachment === "object" &&
        secureConsoleAgentV44Attachment !== null &&
        typeof secureConsoleAgentV44Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV44Attachment =
        await secureConsoleAgentV44Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV44Attachment === "object" &&
        secureConsoleChromeV44Attachment !== null &&
        typeof secureConsoleChromeV44Attachment.documentation === "function" &&
        typeof secureConsoleChromeV44Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV44Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV44Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV44Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV44TerminalOutputFailure = terminalError;
        throw new Error("V44DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV44Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV44Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV44Attachment.user.claimTab(candidate.id);
      ...
      if (!exactCounters) throw new Error("V44AttachmentCompletenessError");
      result = "EXACT_V44Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result ===
        "EXACT_V44Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS") {
      secureConsoleOwnedTaskTabV44Attachment = adopted;
      secureConsoleOwnedTaskTabV44AttachmentEligible = true;
      secureConsoleV44AttachmentState = "V44Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV44Attachment === "function" &&
        secureConsoleAgentV44Attachment !== null && secureConsoleChromeV44Attachment !== null &&
        secureConsoleOwnedTaskTabV44Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV44Attachment = null;
      secureConsoleOwnedTaskTabV44AttachmentEligible = false;
      secureConsoleV44AttachmentState = "V44Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV44Attachment = null;
      secureConsoleAgentV44Attachment = null;
      secureConsoleSetupBrowserRuntimeV44Attachment = null;
    ...
    secureConsoleV44AttachmentEvidence = {
        result,
        declarationShape,
        moduleShape,
        agentShape,
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV44Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV44AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV44Attachment === null,
        state: secureConsoleV44AttachmentState,
    };
  })();
  if (secureConsoleV44TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV44TerminalOutputFailure;
    secureConsoleV44TerminalOutputFailure = null;
    secureConsoleV44AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV44Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V44_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV44Consumed === "boolean" &&
        typeof secureConsoleV44AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV44Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV44AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV44Attachment === "function" &&
        typeof secureConsoleAgentV44Attachment === "object" &&
        secureConsoleAgentV44Attachment !== null &&
        typeof secureConsoleChromeV44Attachment === "object" &&
        secureConsoleChromeV44Attachment !== null &&
        secureConsoleOwnedTaskTabV44 === null &&
        secureConsoleOwnedTaskTabV44Eligible === false &&
        secureConsoleOwnedTaskTabV44State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV44PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV44Consumed === false;
      if (!declarationShape) throw new Error("V44DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV44Consumed === true &&
        secureConsoleV44AttachmentState === "V44Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV44Attachment !== null &&
        secureConsoleOwnedTaskTabV44AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V44AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV44Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V44AttachmentTabOwnershipError");
      ...
      result = "EXACT_V44_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V44_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV44 = adopted;
      secureConsoleOwnedTaskTabV44Eligible = true;
      secureConsoleOwnedTaskTabV44Attachment = null;
      secureConsoleOwnedTaskTabV44AttachmentEligible = false;
      secureConsoleV44AttachmentState = "V44Attachment_TRANSFERRED_TO_V44";
      secureConsoleChromeV44Attachment = null;
      secureConsoleAgentV44Attachment = null;
      secureConsoleSetupBrowserRuntimeV44Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V44_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV44 = null;
        secureConsoleOwnedTaskTabV44Eligible = false;
        secureConsoleOwnedTaskTabV44State =
          "V44_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV44AttachmentState = "V44Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV44 === null &&
          secureConsoleOwnedTaskTabV44Eligible === false &&
          secureConsoleOwnedTaskTabV44Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV44AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV44Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV44Eligible,
        bindingNull: secureConsoleOwnedTaskTabV44 === null,
        state: secureConsoleOwnedTaskTabV44State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV44Attachment === null,
        predecessorState: secureConsoleV44AttachmentState,
      });
      secureConsoleV44AttachmentEvidence = null;
      secureConsoleV44TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV44 = null;
      secureConsoleOwnedTaskTabV44Eligible = false;
      secureConsoleOwnedTaskTabV44State = "V44_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV44Attachment = null;
      secureConsoleOwnedTaskTabV44AttachmentEligible = false;
      secureConsoleV44AttachmentState = "V44Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV44Attachment = null;
      secureConsoleAgentV44Attachment = null;
      secureConsoleSetupBrowserRuntimeV44Attachment = null;
      secureConsoleV44AttachmentEvidence = null;
