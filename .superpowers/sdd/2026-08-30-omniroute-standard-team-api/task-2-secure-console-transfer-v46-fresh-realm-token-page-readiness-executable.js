...
let secureConsoleOwnedTaskTabV46State = "UNADOPTED";
...
await (async () => {
  let secureConsoleV46AttachmentEvidence = null;
  let secureConsoleV46TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV46Attachment = null;
  let secureConsoleAgentV46Attachment = null;
  let secureConsoleChromeV46Attachment = null;
  let secureConsoleOwnedTaskTabV46Attachment = null;
  let secureConsoleOwnedTaskTabV46AttachmentEligible = false;
  let secureConsoleV46AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV46Consumed === false;
    secureConsoleV46Consumed = true;
    ...
    let result = "V46Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V46Attachment_PURE_TRUSTED_LISTING
    ...
    // END_V46Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV46 === null &&
        secureConsoleOwnedTaskTabV46Eligible === false &&
        secureConsoleOwnedTaskTabV46State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV46PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV46PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV46Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV46Attachment === null &&
        secureConsoleAgentV46Attachment === null && secureConsoleChromeV46Attachment === null &&
        secureConsoleOwnedTaskTabV46Attachment === null &&
        secureConsoleOwnedTaskTabV46AttachmentEligible === false &&
        secureConsoleV46AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV46AttachmentState = "V46Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV46Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV46Attachment = await secureConsoleSetupBrowserRuntimeV46Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV46Attachment === "object" &&
        secureConsoleAgentV46Attachment !== null &&
        typeof secureConsoleAgentV46Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV46Attachment =
        await secureConsoleAgentV46Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV46Attachment === "object" &&
        secureConsoleChromeV46Attachment !== null &&
        typeof secureConsoleChromeV46Attachment.documentation === "function" &&
        typeof secureConsoleChromeV46Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV46Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV46Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV46Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV46TerminalOutputFailure = terminalError;
        throw new Error("V46DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV46Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV46Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV46Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V46AttachmentCompletenessError");
    ...
    if (result ===
        "EXACT_V46Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS") {
      secureConsoleOwnedTaskTabV46Attachment = adopted;
      secureConsoleOwnedTaskTabV46AttachmentEligible = true;
      secureConsoleV46AttachmentState = "V46Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV46Attachment === "function" &&
        secureConsoleAgentV46Attachment !== null && secureConsoleChromeV46Attachment !== null &&
        secureConsoleOwnedTaskTabV46Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV46Attachment = null;
      secureConsoleOwnedTaskTabV46AttachmentEligible = false;
      secureConsoleV46AttachmentState = "V46Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV46Attachment = null;
      secureConsoleAgentV46Attachment = null;
      secureConsoleSetupBrowserRuntimeV46Attachment = null;
    ...
    secureConsoleV46AttachmentEvidence = {
        result,
        declarationShape,
        moduleShape,
        agentShape,
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV46Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV46AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV46Attachment === null,
        state: secureConsoleV46AttachmentState,
    };
  })();
  if (secureConsoleV46TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV46TerminalOutputFailure;
    secureConsoleV46TerminalOutputFailure = null;
    secureConsoleV46AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV46Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V46_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV46Consumed === "boolean" &&
        typeof secureConsoleV46AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV46Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV46AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV46Attachment === "function" &&
        typeof secureConsoleAgentV46Attachment === "object" &&
        secureConsoleAgentV46Attachment !== null &&
        typeof secureConsoleChromeV46Attachment === "object" &&
        secureConsoleChromeV46Attachment !== null &&
        secureConsoleOwnedTaskTabV46 === null &&
        secureConsoleOwnedTaskTabV46Eligible === false &&
        secureConsoleOwnedTaskTabV46State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV46PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV46Consumed === false;
      if (!declarationShape) throw new Error("V46DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV46Consumed === true &&
        secureConsoleV46AttachmentState === "V46Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV46Attachment !== null &&
        secureConsoleOwnedTaskTabV46AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V46AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV46Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V46AttachmentTabOwnershipError");
      ...
      result = "EXACT_V46_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V46_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV46 = adopted;
      secureConsoleOwnedTaskTabV46Eligible = true;
      secureConsoleOwnedTaskTabV46Attachment = null;
      secureConsoleOwnedTaskTabV46AttachmentEligible = false;
      secureConsoleV46AttachmentState = "V46Attachment_TRANSFERRED_TO_V46";
      secureConsoleChromeV46Attachment = null;
      secureConsoleAgentV46Attachment = null;
      secureConsoleSetupBrowserRuntimeV46Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V46_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV46 = null;
        secureConsoleOwnedTaskTabV46Eligible = false;
        secureConsoleOwnedTaskTabV46State =
          "V46_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV46AttachmentState = "V46Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV46 === null &&
          secureConsoleOwnedTaskTabV46Eligible === false &&
          secureConsoleOwnedTaskTabV46Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV46AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV46Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV46Eligible,
        bindingNull: secureConsoleOwnedTaskTabV46 === null,
        state: secureConsoleOwnedTaskTabV46State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV46Attachment === null,
        predecessorState: secureConsoleV46AttachmentState,
      });
      secureConsoleV46AttachmentEvidence = null;
      secureConsoleV46TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV46 = null;
      secureConsoleOwnedTaskTabV46Eligible = false;
      secureConsoleOwnedTaskTabV46State = "V46_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV46Attachment = null;
      secureConsoleOwnedTaskTabV46AttachmentEligible = false;
      secureConsoleV46AttachmentState = "V46Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV46Attachment = null;
      secureConsoleAgentV46Attachment = null;
      secureConsoleSetupBrowserRuntimeV46Attachment = null;
      secureConsoleV46AttachmentEvidence = null;
