...
let secureConsoleOwnedTaskTabV47State = "UNADOPTED";
...
await (async () => {
  let secureConsoleV47AttachmentEvidence = null;
  let secureConsoleV47TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV47Attachment = null;
  let secureConsoleAgentV47Attachment = null;
  let secureConsoleChromeV47Attachment = null;
  let secureConsoleOwnedTaskTabV47Attachment = null;
  let secureConsoleOwnedTaskTabV47AttachmentEligible = false;
  let secureConsoleV47AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV47Consumed === false;
    secureConsoleV47Consumed = true;
    ...
    let result = "V47Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V47Attachment_PURE_TRUSTED_LISTING
    ...
    const trustedListing = (value) => {
      ...
      if (validatedUrl !== null) {
        ...
        urlCloudflare =
          ...
          parsed.password === "";
        if (!urlCloudflare) return null;
      }
      return {
        tab: first,
        id: validatedId,
        count: length,
        urlPresent: validatedUrl !== null,
        urlCloudflare,
      };
    };
    // END_V47Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV47 === null &&
        secureConsoleOwnedTaskTabV47Eligible === false &&
        secureConsoleOwnedTaskTabV47State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV47PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV47PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV47Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV47Attachment === null &&
        secureConsoleAgentV47Attachment === null && secureConsoleChromeV47Attachment === null &&
        secureConsoleOwnedTaskTabV47Attachment === null &&
        secureConsoleOwnedTaskTabV47AttachmentEligible === false &&
        secureConsoleV47AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV47AttachmentState = "V47Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV47Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV47Attachment = await secureConsoleSetupBrowserRuntimeV47Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV47Attachment === "object" &&
        secureConsoleAgentV47Attachment !== null &&
        typeof secureConsoleAgentV47Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV47Attachment =
        await secureConsoleAgentV47Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV47Attachment === "object" &&
        secureConsoleChromeV47Attachment !== null &&
        typeof secureConsoleChromeV47Attachment.documentation === "function" &&
        typeof secureConsoleChromeV47Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV47Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV47Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV47Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV47TerminalOutputFailure = terminalError;
        throw new Error("V47DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV47Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV47Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV47Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V47AttachmentCompletenessError");
      result = "EXACT_V47Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result ===
        "EXACT_V47Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS") {
      secureConsoleOwnedTaskTabV47Attachment = adopted;
      secureConsoleOwnedTaskTabV47AttachmentEligible = true;
      secureConsoleV47AttachmentState = "V47Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV47Attachment === "function" &&
        secureConsoleAgentV47Attachment !== null && secureConsoleChromeV47Attachment !== null &&
        secureConsoleOwnedTaskTabV47Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV47Attachment = null;
      secureConsoleOwnedTaskTabV47AttachmentEligible = false;
      secureConsoleV47AttachmentState = "V47Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV47Attachment = null;
      secureConsoleAgentV47Attachment = null;
      secureConsoleSetupBrowserRuntimeV47Attachment = null;
    ...
    secureConsoleV47AttachmentEvidence = {
        result,
        declarationShape,
        moduleShape,
        agentShape,
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV47Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV47AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV47Attachment === null,
        state: secureConsoleV47AttachmentState,
    };
  })();
  if (secureConsoleV47TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV47TerminalOutputFailure;
    secureConsoleV47TerminalOutputFailure = null;
    secureConsoleV47AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV47Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V47_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV47Consumed === "boolean" &&
        typeof secureConsoleV47AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV47Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV47AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV47Attachment === "function" &&
        typeof secureConsoleAgentV47Attachment === "object" &&
        secureConsoleAgentV47Attachment !== null &&
        typeof secureConsoleChromeV47Attachment === "object" &&
        secureConsoleChromeV47Attachment !== null &&
        secureConsoleOwnedTaskTabV47 === null &&
        secureConsoleOwnedTaskTabV47Eligible === false &&
        secureConsoleOwnedTaskTabV47State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV47PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV47Consumed === false;
      if (!declarationShape) throw new Error("V47DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV47Consumed === true &&
        secureConsoleV47AttachmentState === "V47Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV47Attachment !== null &&
        secureConsoleOwnedTaskTabV47AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V47AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV47Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V47AttachmentTabOwnershipError");
      ...
      result = "EXACT_V47_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V47_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV47 = adopted;
      secureConsoleOwnedTaskTabV47Eligible = true;
      secureConsoleOwnedTaskTabV47Attachment = null;
      secureConsoleOwnedTaskTabV47AttachmentEligible = false;
      secureConsoleV47AttachmentState = "V47Attachment_TRANSFERRED_TO_V47";
      secureConsoleChromeV47Attachment = null;
      secureConsoleAgentV47Attachment = null;
      secureConsoleSetupBrowserRuntimeV47Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V47_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV47 = null;
        secureConsoleOwnedTaskTabV47Eligible = false;
        secureConsoleOwnedTaskTabV47State =
          "V47_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV47AttachmentState = "V47Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV47 === null &&
          secureConsoleOwnedTaskTabV47Eligible === false &&
          secureConsoleOwnedTaskTabV47Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV47AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV47Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV47Eligible,
        bindingNull: secureConsoleOwnedTaskTabV47 === null,
        state: secureConsoleOwnedTaskTabV47State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV47Attachment === null,
        predecessorState: secureConsoleV47AttachmentState,
      });
      secureConsoleV47AttachmentEvidence = null;
      secureConsoleV47TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV47 = null;
      secureConsoleOwnedTaskTabV47Eligible = false;
      secureConsoleOwnedTaskTabV47State = "V47_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV47Attachment = null;
      secureConsoleOwnedTaskTabV47AttachmentEligible = false;
      secureConsoleV47AttachmentState = "V47Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV47Attachment = null;
      secureConsoleAgentV47Attachment = null;
      secureConsoleSetupBrowserRuntimeV47Attachment = null;
      secureConsoleV47AttachmentEvidence = null;
