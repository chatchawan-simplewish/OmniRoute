...
let secureConsoleOwnedTaskTabV49State = "UNADOPTED";
...
await (async () => {
  let secureConsoleV49AttachmentEvidence = null;
  let secureConsoleV49TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV49Attachment = null;
  let secureConsoleAgentV49Attachment = null;
  let secureConsoleChromeV49Attachment = null;
  let secureConsoleOwnedTaskTabV49Attachment = null;
  let secureConsoleOwnedTaskTabV49AttachmentEligible = false;
  let secureConsoleV49AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV49Consumed === false;
    secureConsoleV49Consumed = true;
    ...
    let result = "V49Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    // END_V49Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV49 === null &&
        secureConsoleOwnedTaskTabV49Eligible === false &&
        secureConsoleOwnedTaskTabV49State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV49PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV49PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV49Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV49Attachment === null &&
        secureConsoleAgentV49Attachment === null && secureConsoleChromeV49Attachment === null &&
        secureConsoleOwnedTaskTabV49Attachment === null &&
        secureConsoleOwnedTaskTabV49AttachmentEligible === false &&
        secureConsoleV49AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV49AttachmentState = "V49Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV49Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV49Attachment = await secureConsoleSetupBrowserRuntimeV49Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV49Attachment === "object" &&
        secureConsoleAgentV49Attachment !== null &&
        typeof secureConsoleAgentV49Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV49Attachment =
        await secureConsoleAgentV49Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV49Attachment === "object" &&
        secureConsoleChromeV49Attachment !== null &&
        typeof secureConsoleChromeV49Attachment.documentation === "function" &&
        typeof secureConsoleChromeV49Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV49Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV49Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV49Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV49TerminalOutputFailure = terminalError;
        throw new Error("V49DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV49Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV49Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV49Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V49AttachmentCompletenessError");
      result = "EXACT_V49Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }
    ...
    if (result ===
      ...
      secureConsoleOwnedTaskTabV49Attachment = adopted;
      secureConsoleOwnedTaskTabV49AttachmentEligible = true;
      secureConsoleV49AttachmentState = "V49Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV49Attachment === "function" &&
        secureConsoleAgentV49Attachment !== null && secureConsoleChromeV49Attachment !== null &&
        secureConsoleOwnedTaskTabV49Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV49Attachment = null;
      secureConsoleOwnedTaskTabV49AttachmentEligible = false;
      secureConsoleV49AttachmentState = "V49Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV49Attachment = null;
      secureConsoleAgentV49Attachment = null;
      secureConsoleSetupBrowserRuntimeV49Attachment = null;
    ...
    secureConsoleV49AttachmentEvidence = {
        ...
        bindingEligible: secureConsoleOwnedTaskTabV49AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV49Attachment === null,
        state: secureConsoleV49AttachmentState,
    };
  })();
  ...
  await (async () => {
    const gateWasFresh = secureConsoleV49Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V49_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV49Consumed === "boolean" &&
        typeof secureConsoleV49AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV49Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV49AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV49Attachment === "function" &&
        typeof secureConsoleAgentV49Attachment === "object" &&
        secureConsoleAgentV49Attachment !== null &&
        typeof secureConsoleChromeV49Attachment === "object" &&
        secureConsoleChromeV49Attachment !== null &&
        secureConsoleOwnedTaskTabV49 === null &&
        secureConsoleOwnedTaskTabV49Eligible === false &&
        secureConsoleOwnedTaskTabV49State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV49PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV49Consumed === false;
      if (!declarationShape) throw new Error("V49DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV49Consumed === true &&
        secureConsoleV49AttachmentState === "V49Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV49Attachment !== null &&
        secureConsoleOwnedTaskTabV49AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V49AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV49Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V49AttachmentTabOwnershipError");
      ...
      result = "EXACT_V49_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V49_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV49 = adopted;
      secureConsoleOwnedTaskTabV49Eligible = true;
      secureConsoleOwnedTaskTabV49Attachment = null;
      secureConsoleOwnedTaskTabV49AttachmentEligible = false;
      secureConsoleV49AttachmentState = "V49Attachment_TRANSFERRED_TO_V49";
      secureConsoleChromeV49Attachment = null;
      secureConsoleAgentV49Attachment = null;
      secureConsoleSetupBrowserRuntimeV49Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        secureConsoleV49AttachmentState = "V49Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV49 === null &&
          secureConsoleOwnedTaskTabV49Eligible === false &&
          secureConsoleOwnedTaskTabV49Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV49AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV49Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV49Eligible,
        bindingNull: secureConsoleOwnedTaskTabV49 === null,
        state: secureConsoleOwnedTaskTabV49State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV49Attachment === null,
        predecessorState: secureConsoleV49AttachmentState,
      });
      secureConsoleV49AttachmentEvidence = null;
      secureConsoleV49TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV49 = null;
      secureConsoleOwnedTaskTabV49Eligible = false;
      secureConsoleOwnedTaskTabV49State = "V49_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV49Attachment = null;
      secureConsoleOwnedTaskTabV49AttachmentEligible = false;
      secureConsoleV49AttachmentState = "V49Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV49Attachment = null;
      secureConsoleAgentV49Attachment = null;
      secureConsoleSetupBrowserRuntimeV49Attachment = null;
      secureConsoleV49AttachmentEvidence = null;
