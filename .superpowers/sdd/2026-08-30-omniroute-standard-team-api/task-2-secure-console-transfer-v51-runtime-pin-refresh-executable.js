...
let secureConsoleOwnedTaskTabV51State = "UNADOPTED";
...
await (async () => {
  let secureConsoleV51AttachmentEvidence = null;
  let secureConsoleV51TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV51Attachment = null;
  let secureConsoleAgentV51Attachment = null;
  let secureConsoleChromeV51Attachment = null;
  let secureConsoleOwnedTaskTabV51Attachment = null;
  let secureConsoleOwnedTaskTabV51AttachmentEligible = false;
  let secureConsoleV51AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV51Consumed === false;
    secureConsoleV51Consumed = true;
    ...
    let result = "V51Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    // END_V51Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV51 === null &&
        secureConsoleOwnedTaskTabV51Eligible === false &&
        secureConsoleOwnedTaskTabV51State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV51PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV51PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV51Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV51Attachment === null &&
        secureConsoleAgentV51Attachment === null && secureConsoleChromeV51Attachment === null &&
        secureConsoleOwnedTaskTabV51Attachment === null &&
        secureConsoleOwnedTaskTabV51AttachmentEligible === false &&
        secureConsoleV51AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV51AttachmentState = "V51Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV51Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV51Attachment = await secureConsoleSetupBrowserRuntimeV51Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV51Attachment === "object" &&
        secureConsoleAgentV51Attachment !== null &&
        typeof secureConsoleAgentV51Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV51Attachment =
        await secureConsoleAgentV51Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV51Attachment === "object" &&
        secureConsoleChromeV51Attachment !== null &&
        typeof secureConsoleChromeV51Attachment.documentation === "function" &&
        typeof secureConsoleChromeV51Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV51Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV51Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV51Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV51TerminalOutputFailure = terminalError;
        throw new Error("V51DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV51Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV51Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV51Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V51AttachmentCompletenessError");
      result = "EXACT_V51Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }
    ...
    if (result ===
      ...
      secureConsoleOwnedTaskTabV51Attachment = adopted;
      secureConsoleOwnedTaskTabV51AttachmentEligible = true;
      secureConsoleV51AttachmentState = "V51Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV51Attachment === "function" &&
        secureConsoleAgentV51Attachment !== null && secureConsoleChromeV51Attachment !== null &&
        secureConsoleOwnedTaskTabV51Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV51Attachment = null;
      secureConsoleOwnedTaskTabV51AttachmentEligible = false;
      secureConsoleV51AttachmentState = "V51Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV51Attachment = null;
      secureConsoleAgentV51Attachment = null;
      secureConsoleSetupBrowserRuntimeV51Attachment = null;
    ...
    secureConsoleV51AttachmentEvidence = {
        ...
        bindingEligible: secureConsoleOwnedTaskTabV51AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV51Attachment === null,
        state: secureConsoleV51AttachmentState,
    };
  })();
  ...
  await (async () => {
    const gateWasFresh = secureConsoleV51Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V51_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV51Consumed === "boolean" &&
        typeof secureConsoleV51AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV51Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV51AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV51Attachment === "function" &&
        typeof secureConsoleAgentV51Attachment === "object" &&
        secureConsoleAgentV51Attachment !== null &&
        typeof secureConsoleChromeV51Attachment === "object" &&
        secureConsoleChromeV51Attachment !== null &&
        secureConsoleOwnedTaskTabV51 === null &&
        secureConsoleOwnedTaskTabV51Eligible === false &&
        secureConsoleOwnedTaskTabV51State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV51PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV51Consumed === false;
      if (!declarationShape) throw new Error("V51DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV51Consumed === true &&
        secureConsoleV51AttachmentState === "V51Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV51Attachment !== null &&
        secureConsoleOwnedTaskTabV51AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V51AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV51Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V51AttachmentTabOwnershipError");
      ...
      result = "EXACT_V51_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V51_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV51 = adopted;
      secureConsoleOwnedTaskTabV51Eligible = true;
      secureConsoleOwnedTaskTabV51Attachment = null;
      secureConsoleOwnedTaskTabV51AttachmentEligible = false;
      secureConsoleV51AttachmentState = "V51Attachment_TRANSFERRED_TO_V51";
      secureConsoleChromeV51Attachment = null;
      secureConsoleAgentV51Attachment = null;
      secureConsoleSetupBrowserRuntimeV51Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V51_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV51 = null;
        secureConsoleOwnedTaskTabV51Eligible = false;
        secureConsoleOwnedTaskTabV51State =
          "V51_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV51AttachmentState = "V51Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV51 === null &&
          secureConsoleOwnedTaskTabV51Eligible === false &&
          secureConsoleOwnedTaskTabV51Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV51AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV51Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV51Eligible,
        bindingNull: secureConsoleOwnedTaskTabV51 === null,
        state: secureConsoleOwnedTaskTabV51State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV51Attachment === null,
        predecessorState: secureConsoleV51AttachmentState,
      });
      secureConsoleV51AttachmentEvidence = null;
      secureConsoleV51TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV51 = null;
      secureConsoleOwnedTaskTabV51Eligible = false;
      secureConsoleOwnedTaskTabV51State = "V51_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV51Attachment = null;
      secureConsoleOwnedTaskTabV51AttachmentEligible = false;
      secureConsoleV51AttachmentState = "V51Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV51Attachment = null;
      secureConsoleAgentV51Attachment = null;
      secureConsoleSetupBrowserRuntimeV51Attachment = null;
      secureConsoleV51AttachmentEvidence = null;
