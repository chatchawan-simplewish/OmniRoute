let secureConsoleOwnedTaskTabV52 = null;
let secureConsoleOwnedTaskTabV52Eligible = false;
let secureConsoleOwnedTaskTabV52State = "UNADOPTED";
let secureConsoleOwnedTaskTabV52PreCreateDetachConsumed = false;
let secureConsoleOwnedTaskTabV52PostNativeDetachConsumed = false;
let secureConsoleCloudflareReadsV52Consumed = false;
let secureConsoleV52Consumed = false;
const secureConsoleV52SourceProjection = Object.freeze({
  records: 10619,
  sha256: "89D36435A31AE04E560A27D53D8A0953F19E837DF60837FADCF3DC174C0B9477",
});
await (async () => {
  let secureConsoleV52AttachmentEvidence = null;
  let secureConsoleV52TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV52Attachment = null;
  let secureConsoleAgentV52Attachment = null;
  let secureConsoleChromeV52Attachment = null;
  let secureConsoleOwnedTaskTabV52Attachment = null;
  let secureConsoleOwnedTaskTabV52AttachmentEligible = false;
  let secureConsoleV52AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV52Consumed === false;
    secureConsoleV52Consumed = true;
    ...
    let result = "V52Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    // END_V52Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV52 === null &&
        secureConsoleOwnedTaskTabV52Eligible === false &&
        secureConsoleOwnedTaskTabV52State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV52PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV52PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV52Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV52Attachment === null &&
        secureConsoleAgentV52Attachment === null && secureConsoleChromeV52Attachment === null &&
        secureConsoleOwnedTaskTabV52Attachment === null &&
        secureConsoleOwnedTaskTabV52AttachmentEligible === false &&
        secureConsoleV52AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV52AttachmentState = "V52Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV52Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV52Attachment = await secureConsoleSetupBrowserRuntimeV52Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV52Attachment === "object" &&
        secureConsoleAgentV52Attachment !== null &&
        typeof secureConsoleAgentV52Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV52Attachment =
        await secureConsoleAgentV52Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV52Attachment === "object" &&
        secureConsoleChromeV52Attachment !== null &&
        typeof secureConsoleChromeV52Attachment.documentation === "function" &&
        typeof secureConsoleChromeV52Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV52Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV52Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV52Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV52TerminalOutputFailure = terminalError;
        throw new Error("V52DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV52Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV52Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV52Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V52AttachmentCompletenessError");
      result = "EXACT_V52Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }
    ...
    if (result ===
      ...
      secureConsoleOwnedTaskTabV52Attachment = adopted;
      secureConsoleOwnedTaskTabV52AttachmentEligible = true;
      secureConsoleV52AttachmentState = "V52Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV52Attachment === "function" &&
        secureConsoleAgentV52Attachment !== null && secureConsoleChromeV52Attachment !== null &&
        secureConsoleOwnedTaskTabV52Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV52Attachment = null;
      secureConsoleOwnedTaskTabV52AttachmentEligible = false;
      secureConsoleV52AttachmentState = "V52Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV52Attachment = null;
      secureConsoleAgentV52Attachment = null;
      secureConsoleSetupBrowserRuntimeV52Attachment = null;
    ...
    secureConsoleV52AttachmentEvidence = {
        ...
        bindingEligible: secureConsoleOwnedTaskTabV52AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV52Attachment === null,
        state: secureConsoleV52AttachmentState,
    };
  })();
  ...
  await (async () => {
    const gateWasFresh = secureConsoleV52Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V52_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV52Consumed === "boolean" &&
        typeof secureConsoleV52AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV52Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV52AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV52Attachment === "function" &&
        typeof secureConsoleAgentV52Attachment === "object" &&
        secureConsoleAgentV52Attachment !== null &&
        typeof secureConsoleChromeV52Attachment === "object" &&
        secureConsoleChromeV52Attachment !== null &&
        secureConsoleOwnedTaskTabV52 === null &&
        secureConsoleOwnedTaskTabV52Eligible === false &&
        secureConsoleOwnedTaskTabV52State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV52PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV52Consumed === false;
      if (!declarationShape) throw new Error("V52DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV52Consumed === true &&
        secureConsoleV52AttachmentState === "V52Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV52Attachment !== null &&
        secureConsoleOwnedTaskTabV52AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V52AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV52Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V52AttachmentTabOwnershipError");
      ...
      result = "EXACT_V52_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V52_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV52 = adopted;
      secureConsoleOwnedTaskTabV52Eligible = true;
      secureConsoleOwnedTaskTabV52Attachment = null;
      secureConsoleOwnedTaskTabV52AttachmentEligible = false;
      secureConsoleV52AttachmentState = "V52Attachment_TRANSFERRED_TO_V52";
      secureConsoleChromeV52Attachment = null;
      secureConsoleAgentV52Attachment = null;
      secureConsoleSetupBrowserRuntimeV52Attachment = null;
      ...
      if (continuationBindingsRetained) {
        secureConsoleOwnedTaskTabV52State =
          "TOKEN_PAGE_SEMANTIC_READY_ELIGIBLE";
      } else {
        result = "V52_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV52 = null;
        secureConsoleOwnedTaskTabV52Eligible = false;
        secureConsoleOwnedTaskTabV52State =
          "V52_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV52AttachmentState = "V52Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV52 === null &&
          secureConsoleOwnedTaskTabV52Eligible === false &&
          secureConsoleOwnedTaskTabV52Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV52AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV52Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV52Eligible,
        bindingNull: secureConsoleOwnedTaskTabV52 === null,
        state: secureConsoleOwnedTaskTabV52State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV52Attachment === null,
        predecessorState: secureConsoleV52AttachmentState,
      });
      secureConsoleV52AttachmentEvidence = null;
      secureConsoleV52TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV52 = null;
      secureConsoleOwnedTaskTabV52Eligible = false;
      secureConsoleOwnedTaskTabV52State = "V52_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV52Attachment = null;
      secureConsoleOwnedTaskTabV52AttachmentEligible = false;
      secureConsoleV52AttachmentState = "V52Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV52Attachment = null;
      secureConsoleAgentV52Attachment = null;
      secureConsoleSetupBrowserRuntimeV52Attachment = null;
      secureConsoleV52AttachmentEvidence = null;
