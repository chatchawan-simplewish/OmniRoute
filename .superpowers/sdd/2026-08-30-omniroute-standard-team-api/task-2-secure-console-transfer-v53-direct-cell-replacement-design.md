...
The committed executable must be ASCII and no more than **25,000 UTF-8 bytes**;
this is the smallest rounded ceiling above the measured 24,290-byte mechanical
compression that preserves all seven persistent declarations and runtime reads.
