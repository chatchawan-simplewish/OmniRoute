let secureConsoleOwnedTaskTabV54 = null;
let secureConsoleOwnedTaskTabV54Eligible = false;
let secureConsoleOwnedTaskTabV54State = "UNADOPTED";
let secureConsoleOwnedTaskTabV54PreCreateDetachConsumed = false;
let secureConsoleOwnedTaskTabV54PostNativeDetachConsumed = false;
let secureConsoleCloudflareReadsV54Consumed = false;
let secureConsoleV54Consumed = false;
const secureConsoleV54SourceProjection = Object.freeze({
  records: 10619,
  sha256: "89D36435A31AE04E560A27D53D8A0953F19E837DF60837FADCF3DC174C0B9477",
});
await (async () => {
  let secureConsoleV54AttachmentEvidence = null;
  let secureConsoleV54TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV54Attachment = null;
  let secureConsoleAgentV54Attachment = null;
  let secureConsoleChromeV54Attachment = null;
  let secureConsoleOwnedTaskTabV54Attachment = null;
  let secureConsoleOwnedTaskTabV54AttachmentEligible = false;
  let secureConsoleV54AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV54Consumed === false;
    secureConsoleV54Consumed = true;
    ...
    let result = "V54Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V54Attachment_PURE_TRUSTED_LISTING
    ...
    // END_V54Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV54 === null &&
        secureConsoleOwnedTaskTabV54Eligible === false &&
        secureConsoleOwnedTaskTabV54State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV54PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV54PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV54Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV54Attachment === null &&
        secureConsoleAgentV54Attachment === null && secureConsoleChromeV54Attachment === null &&
        secureConsoleOwnedTaskTabV54Attachment === null &&
        secureConsoleOwnedTaskTabV54AttachmentEligible === false &&
        secureConsoleV54AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV54AttachmentState = "V54Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV54Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV54Attachment = await secureConsoleSetupBrowserRuntimeV54Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV54Attachment === "object" &&
        secureConsoleAgentV54Attachment !== null &&
        typeof secureConsoleAgentV54Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV54Attachment =
        await secureConsoleAgentV54Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV54Attachment === "object" &&
        secureConsoleChromeV54Attachment !== null &&
        typeof secureConsoleChromeV54Attachment.documentation === "function" &&
        typeof secureConsoleChromeV54Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV54Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV54Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV54Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV54TerminalOutputFailure = terminalError;
        throw new Error("V54DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV54Attachment.nameSession("🔐 OmniRoute secure console");
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV54Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV54Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V54AttachmentCompletenessError");
      result = "EXACT_V54Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }
    ...
    if (result ===
      ...
      secureConsoleOwnedTaskTabV54Attachment = adopted;
      secureConsoleOwnedTaskTabV54AttachmentEligible = true;
      secureConsoleV54AttachmentState = "V54Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV54Attachment === "function" &&
        secureConsoleAgentV54Attachment !== null && secureConsoleChromeV54Attachment !== null &&
        secureConsoleOwnedTaskTabV54Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV54Attachment = null;
      secureConsoleOwnedTaskTabV54AttachmentEligible = false;
      secureConsoleV54AttachmentState = "V54Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV54Attachment = null;
      secureConsoleAgentV54Attachment = null;
      secureConsoleSetupBrowserRuntimeV54Attachment = null;
    ...
    secureConsoleV54AttachmentEvidence = {
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV54Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV54AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV54Attachment === null,
        state: secureConsoleV54AttachmentState,
    };
  })();
  if (secureConsoleV54TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV54TerminalOutputFailure;
    secureConsoleV54TerminalOutputFailure = null;
    secureConsoleV54AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV54Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V54_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV54Consumed === "boolean" &&
        typeof secureConsoleV54AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV54Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV54AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV54Attachment === "function" &&
        typeof secureConsoleAgentV54Attachment === "object" &&
        secureConsoleAgentV54Attachment !== null &&
        typeof secureConsoleChromeV54Attachment === "object" &&
        secureConsoleChromeV54Attachment !== null &&
        secureConsoleOwnedTaskTabV54 === null &&
        secureConsoleOwnedTaskTabV54Eligible === false &&
        secureConsoleOwnedTaskTabV54State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV54PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV54Consumed === false;
      if (!declarationShape) throw new Error("V54DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV54Consumed === true &&
        secureConsoleV54AttachmentState === "V54Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV54Attachment !== null &&
        secureConsoleOwnedTaskTabV54AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V54AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV54Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V54AttachmentTabOwnershipError");
      ...
      const noResultsRow = tokenTable.getByText(
        "No results found for your search", { exact: true },
      );
      counters.readinessAttempted++;
      await noResultsRow.waitFor({ state: "visible", timeoutMs: 20000 });
      counters.readinessFulfilled++;
      noResultsRowCount = await noResultsRow.count();
      ...
      tokenFilterComplete =
        tokenInitialFilterEmpty && baselineRowCount >= 1 &&
      ...
      result = "EXACT_V54_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V54_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV54 = adopted;
      secureConsoleOwnedTaskTabV54Eligible = true;
      secureConsoleOwnedTaskTabV54Attachment = null;
      secureConsoleOwnedTaskTabV54AttachmentEligible = false;
      secureConsoleV54AttachmentState = "V54Attachment_TRANSFERRED_TO_V54";
      secureConsoleChromeV54Attachment = null;
      secureConsoleAgentV54Attachment = null;
      secureConsoleSetupBrowserRuntimeV54Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V54_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV54 = null;
        secureConsoleOwnedTaskTabV54Eligible = false;
        secureConsoleOwnedTaskTabV54State =
          "V54_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV54AttachmentState = "V54Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV54 === null &&
          secureConsoleOwnedTaskTabV54Eligible === false &&
          secureConsoleOwnedTaskTabV54Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV54AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV54Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV54Eligible,
        bindingNull: secureConsoleOwnedTaskTabV54 === null,
        state: secureConsoleOwnedTaskTabV54State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV54Attachment === null,
        predecessorState: secureConsoleV54AttachmentState,
      });
      secureConsoleV54AttachmentEvidence = null;
      secureConsoleV54TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV54 = null;
      secureConsoleOwnedTaskTabV54Eligible = false;
      secureConsoleOwnedTaskTabV54State = "V54_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV54Attachment = null;
      secureConsoleOwnedTaskTabV54AttachmentEligible = false;
      secureConsoleV54AttachmentState = "V54Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV54Attachment = null;
      secureConsoleAgentV54Attachment = null;
      secureConsoleSetupBrowserRuntimeV54Attachment = null;
      secureConsoleV54AttachmentEvidence = null;
