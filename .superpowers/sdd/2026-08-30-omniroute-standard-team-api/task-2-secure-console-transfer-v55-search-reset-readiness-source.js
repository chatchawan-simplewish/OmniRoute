let secureConsoleOwnedTaskTabV55 = null;
let secureConsoleOwnedTaskTabV55Eligible = false;
let secureConsoleOwnedTaskTabV55State = "UNADOPTED";
let secureConsoleOwnedTaskTabV55PreCreateDetachConsumed = false;
let secureConsoleOwnedTaskTabV55PostNativeDetachConsumed = false;
let secureConsoleCloudflareReadsV55Consumed = false;
let secureConsoleV55Consumed = false;
const secureConsoleV55SourceProjection = Object.freeze({
  records: 10619,
  sha256: "89D36435A31AE04E560A27D53D8A0953F19E837DF60837FADCF3DC174C0B9477",
});
await (async () => {
  let secureConsoleV55AttachmentEvidence = null;
  let secureConsoleV55TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV55Attachment = null;
  let secureConsoleAgentV55Attachment = null;
  let secureConsoleChromeV55Attachment = null;
  let secureConsoleOwnedTaskTabV55Attachment = null;
  let secureConsoleOwnedTaskTabV55AttachmentEligible = false;
  let secureConsoleV55AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV55Consumed === false;
    secureConsoleV55Consumed = true;
    ...
    let result = "V55Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V55Attachment_PURE_TRUSTED_LISTING
    ...
    // END_V55Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV55 === null &&
        secureConsoleOwnedTaskTabV55Eligible === false &&
        secureConsoleOwnedTaskTabV55State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV55PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV55PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV55Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV55Attachment === null &&
        secureConsoleAgentV55Attachment === null && secureConsoleChromeV55Attachment === null &&
        secureConsoleOwnedTaskTabV55Attachment === null &&
        secureConsoleOwnedTaskTabV55AttachmentEligible === false &&
        secureConsoleV55AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV55AttachmentState = "V55Attachment_CONSUMING";
      ...
      secureConsoleSetupBrowserRuntimeV55Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV55Attachment = await secureConsoleSetupBrowserRuntimeV55Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV55Attachment === "object" &&
        secureConsoleAgentV55Attachment !== null &&
        typeof secureConsoleAgentV55Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV55Attachment =
        await secureConsoleAgentV55Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV55Attachment === "object" &&
        secureConsoleChromeV55Attachment !== null &&
        typeof secureConsoleChromeV55Attachment.documentation === "function" &&
        typeof secureConsoleChromeV55Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV55Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV55Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV55Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV55TerminalOutputFailure = terminalError;
        throw new Error("V55DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV55Attachment.nameSession(
      ...
      const offered = await secureConsoleChromeV55Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV55Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V55AttachmentCompletenessError");
      result = "EXACT_V55Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }
    ...
    if (result ===
      ...
      secureConsoleOwnedTaskTabV55Attachment = adopted;
      secureConsoleOwnedTaskTabV55AttachmentEligible = true;
      secureConsoleV55AttachmentState = "V55Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV55Attachment === "function" &&
        secureConsoleAgentV55Attachment !== null && secureConsoleChromeV55Attachment !== null &&
        secureConsoleOwnedTaskTabV55Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV55Attachment = null;
      secureConsoleOwnedTaskTabV55AttachmentEligible = false;
      secureConsoleV55AttachmentState = "V55Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV55Attachment = null;
      secureConsoleAgentV55Attachment = null;
      secureConsoleSetupBrowserRuntimeV55Attachment = null;
    ...
    secureConsoleV55AttachmentEvidence = {
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV55Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV55AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV55Attachment === null,
        state: secureConsoleV55AttachmentState,
    };
  })();
  if (secureConsoleV55TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV55TerminalOutputFailure;
    secureConsoleV55TerminalOutputFailure = null;
    secureConsoleV55AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV55Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
    ...
    let result = "V55_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV55Consumed === "boolean" &&
        typeof secureConsoleV55AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV55Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV55AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV55Attachment === "function" &&
        typeof secureConsoleAgentV55Attachment === "object" &&
        secureConsoleAgentV55Attachment !== null &&
        typeof secureConsoleChromeV55Attachment === "object" &&
        secureConsoleChromeV55Attachment !== null &&
        secureConsoleOwnedTaskTabV55 === null &&
        secureConsoleOwnedTaskTabV55Eligible === false &&
        secureConsoleOwnedTaskTabV55State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV55PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV55Consumed === false;
      if (!declarationShape) throw new Error("V55DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV55Consumed === true &&
        secureConsoleV55AttachmentState === "V55Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV55Attachment !== null &&
        secureConsoleOwnedTaskTabV55AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V55AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV55Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V55AttachmentTabOwnershipError");
      ...
      result = "EXACT_V55_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V55_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV55 = adopted;
      secureConsoleOwnedTaskTabV55Eligible = true;
      secureConsoleOwnedTaskTabV55Attachment = null;
      secureConsoleOwnedTaskTabV55AttachmentEligible = false;
      secureConsoleV55AttachmentState = "V55Attachment_TRANSFERRED_TO_V55";
      secureConsoleChromeV55Attachment = null;
      secureConsoleAgentV55Attachment = null;
      secureConsoleSetupBrowserRuntimeV55Attachment = null;
      ...
      if (continuationBindingsRetained) {
        secureConsoleOwnedTaskTabV55State =
          "TOKEN_PAGE_SEMANTIC_READY_ELIGIBLE";
      } else {
        result = "V55_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV55 = null;
        secureConsoleOwnedTaskTabV55Eligible = false;
        secureConsoleOwnedTaskTabV55State =
          "V55_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV55AttachmentState = "V55Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV55 === null &&
          secureConsoleOwnedTaskTabV55Eligible === false &&
          secureConsoleOwnedTaskTabV55Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV55AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV55Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV55Eligible,
        bindingNull: secureConsoleOwnedTaskTabV55 === null,
        state: secureConsoleOwnedTaskTabV55State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV55Attachment === null,
        predecessorState: secureConsoleV55AttachmentState,
      });
      secureConsoleV55AttachmentEvidence = null;
      secureConsoleV55TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV55 = null;
      secureConsoleOwnedTaskTabV55Eligible = false;
      secureConsoleOwnedTaskTabV55State = "V55_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV55Attachment = null;
      secureConsoleOwnedTaskTabV55AttachmentEligible = false;
      secureConsoleV55AttachmentState = "V55Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV55Attachment = null;
      secureConsoleAgentV55Attachment = null;
      secureConsoleSetupBrowserRuntimeV55Attachment = null;
      secureConsoleV55AttachmentEvidence = null;
