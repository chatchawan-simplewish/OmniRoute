let secureConsoleOwnedTaskTabV56 = null;
let secureConsoleOwnedTaskTabV56Eligible = false;
let secureConsoleOwnedTaskTabV56State = "UNADOPTED";
let secureConsoleOwnedTaskTabV56PreCreateDetachConsumed = false;
let secureConsoleOwnedTaskTabV56PostNativeDetachConsumed = false;
let secureConsoleCloudflareReadsV56Consumed = false;
let secureConsoleV56Consumed = false;
const secureConsoleV56SourceProjection = Object.freeze({
  records: 10619,
  sha256: "89D36435A31AE04E560A27D53D8A0953F19E837DF60837FADCF3DC174C0B9477",
});
await (async () => {
  let secureConsoleV56AttachmentEvidence = null;
  let secureConsoleV56TerminalOutputFailure = null;
  let secureConsoleSetupBrowserRuntimeV56Attachment = null;
  let secureConsoleAgentV56Attachment = null;
  let secureConsoleChromeV56Attachment = null;
  let secureConsoleOwnedTaskTabV56Attachment = null;
  let secureConsoleOwnedTaskTabV56AttachmentEligible = false;
  let secureConsoleV56AttachmentState = "UNCREATED";
  await (async () => {
    const gateWasFresh = secureConsoleV56Consumed === false;
    secureConsoleV56Consumed = true;
    const predecessorDeclarationsAbsent =
      ...
      typeof secureConsoleOwnedTaskTabV50 === "undefined" &&
      typeof secureConsoleOwnedTaskTabV50Eligible === "undefined" &&
      typeof secureConsoleOwnedTaskTabV50State === "undefined" &&
      typeof secureConsoleOwnedTaskTabV50PreCreateDetachConsumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV50PostNativeDetachConsumed === "undefined" &&
      typeof secureConsoleCloudflareReadsV50Consumed === "undefined" &&
      typeof secureConsoleV50Consumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV51 === "undefined" &&
      typeof secureConsoleOwnedTaskTabV51Eligible === "undefined" &&
      typeof secureConsoleOwnedTaskTabV51State === "undefined" &&
      typeof secureConsoleOwnedTaskTabV51PreCreateDetachConsumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV51PostNativeDetachConsumed === "undefined" &&
      typeof secureConsoleCloudflareReadsV51Consumed === "undefined" &&
      typeof secureConsoleV51Consumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV53 === "undefined" &&
      typeof secureConsoleOwnedTaskTabV53Eligible === "undefined" &&
      typeof secureConsoleOwnedTaskTabV53State === "undefined" &&
      typeof secureConsoleOwnedTaskTabV53PreCreateDetachConsumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV53PostNativeDetachConsumed === "undefined" &&
      typeof secureConsoleCloudflareReadsV53Consumed === "undefined" &&
      typeof secureConsoleV53Consumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV54 === "undefined" &&
      typeof secureConsoleOwnedTaskTabV54Eligible === "undefined" &&
      typeof secureConsoleOwnedTaskTabV54State === "undefined" &&
      typeof secureConsoleOwnedTaskTabV54PreCreateDetachConsumed === "undefined" &&
      typeof secureConsoleOwnedTaskTabV54PostNativeDetachConsumed === "undefined" &&
      typeof secureConsoleCloudflareReadsV54Consumed === "undefined" &&
      typeof secureConsoleV54Consumed === "undefined";
    const counters = {
    ...
    let result = "V56Attachment_FRESH_CROSS_REALM_TASK_REACQUISITION_FAILED_STOP";
    ...
    let adopted = null;
    let errorClass = "NONE";
    // BEGIN_V56Attachment_PURE_TRUSTED_LISTING
    ...
    // END_V56Attachment_PURE_TRUSTED_LISTING
    ...
    try {
      declarationShape =
        ...
        secureConsoleOwnedTaskTabV56 === null &&
        secureConsoleOwnedTaskTabV56Eligible === false &&
        secureConsoleOwnedTaskTabV56State === "UNADOPTED" &&
        secureConsoleOwnedTaskTabV56PreCreateDetachConsumed === false &&
        secureConsoleOwnedTaskTabV56PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV56Consumed === false &&
        typeof secureConsoleV35AttachmentConsumed === "undefined" &&
        typeof secureConsoleV35AdoptionConsumed === "undefined" &&
        typeof secureConsoleV36Consumed === "undefined" &&
        typeof secureConsoleV37Consumed === "undefined" &&
        ...
        typeof secureConsoleV40Consumed === "undefined" &&
        typeof secureConsoleOwnedTaskTabV40 === "undefined" &&
        secureConsoleSetupBrowserRuntimeV56Attachment === null &&
        secureConsoleAgentV56Attachment === null && secureConsoleChromeV56Attachment === null &&
        secureConsoleOwnedTaskTabV56Attachment === null &&
        secureConsoleOwnedTaskTabV56AttachmentEligible === false &&
        secureConsoleV56AttachmentState === "UNCREATED";
      if (!declarationShape) throw new Error("FreshRealmDeclarationError");
      secureConsoleV56AttachmentState = "V56Attachment_CONSUMING";

      counters.importAttempted++;
      const imported = await import(
        "file:///C:/Users/chatc/.codex/plugins/cache/openai-bundled/chrome/26.901.20858/scripts/browser-client.mjs"
      );
      ...
      secureConsoleSetupBrowserRuntimeV56Attachment = imported.setupBrowserRuntime;

      counters.setupAttempted++;
      secureConsoleAgentV56Attachment = await secureConsoleSetupBrowserRuntimeV56Attachment();
      counters.setupFulfilled++;
      agentShape = typeof secureConsoleAgentV56Attachment === "object" &&
        secureConsoleAgentV56Attachment !== null &&
        typeof secureConsoleAgentV56Attachment.browsers?.get === "function";
      if (!agentShape) throw new Error("FreshRuntimeAgentShapeError");

      counters.connectAttempted++;
      secureConsoleChromeV56Attachment =
        await secureConsoleAgentV56Attachment.browsers.get("chrome");
      counters.connectFulfilled++;
      connectedShape = typeof secureConsoleChromeV56Attachment === "object" &&
        secureConsoleChromeV56Attachment !== null &&
        typeof secureConsoleChromeV56Attachment.documentation === "function" &&
        typeof secureConsoleChromeV56Attachment.nameSession === "function" &&
        typeof secureConsoleChromeV56Attachment.user?.openTabs === "function" &&
        typeof secureConsoleChromeV56Attachment.user?.claimTab === "function";
      if (!connectedShape) throw new Error("FreshChromeShapeError");

      counters.documentationAttempted++;
      const documentation = await secureConsoleChromeV56Attachment.documentation();
      ...
      try {
        ...
        secureConsoleV56TerminalOutputFailure = terminalError;
        throw new Error("V56DocumentationOutputError");
      }

      counters.nameAttempted++;
      await secureConsoleChromeV56Attachment.nameSession(
        String.fromCodePoint(0x1F510) + " OmniRoute secure console",
      );
      counters.nameFulfilled++;
      sessionNamed = true;

      counters.openTabsAttempted++;
      const offered = await secureConsoleChromeV56Attachment.user.openTabs();
      ...
      adopted = await secureConsoleChromeV56Attachment.user.claimTab(candidate.tab);
      ...
      if (!exactCounters) throw new Error("V56AttachmentCompletenessError");
      result = "EXACT_V56Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result ===
        "EXACT_V56Attachment_CROSS_REALM_TASK_TAB_ACCOUNT_HOME_REACQUISITION_PASS") {
      secureConsoleOwnedTaskTabV56Attachment = adopted;
      secureConsoleOwnedTaskTabV56AttachmentEligible = true;
      secureConsoleV56AttachmentState = "V56Attachment_ACCOUNT_HOME_READY_ELIGIBLE";
      continuationBindingsRetained =
        typeof secureConsoleSetupBrowserRuntimeV56Attachment === "function" &&
        secureConsoleAgentV56Attachment !== null && secureConsoleChromeV56Attachment !== null &&
        secureConsoleOwnedTaskTabV56Attachment !== null;
    } else {
      secureConsoleOwnedTaskTabV56Attachment = null;
      secureConsoleOwnedTaskTabV56AttachmentEligible = false;
      secureConsoleV56AttachmentState = "V56Attachment_REACQUISITION_OR_READINESS_FAILED";
      secureConsoleChromeV56Attachment = null;
      secureConsoleAgentV56Attachment = null;
      secureConsoleSetupBrowserRuntimeV56Attachment = null;
    ...
    secureConsoleV56AttachmentEvidence = {
        result,
        declarationShape,
        moduleShape,
        agentShape,
        ...
        ...counters,
        errorClass,
        consumed: secureConsoleV56Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV56AttachmentEligible,
        bindingNull: secureConsoleOwnedTaskTabV56Attachment === null,
        state: secureConsoleV56AttachmentState,
    };
  })();
  if (secureConsoleV56TerminalOutputFailure !== null) {
    const terminalOutputFailure = secureConsoleV56TerminalOutputFailure;
    secureConsoleV56TerminalOutputFailure = null;
    secureConsoleV56AttachmentEvidence = null;
    throw terminalOutputFailure;
  }
  await (async () => {
    const gateWasFresh = secureConsoleV56Consumed === true;
    const counters = {
      bindingAttempted: 0,
      bindingFulfilled: 0,
      ...
      initialReadAttempted: 0,
      initialReadFulfilled: 0,
      fillAttempted: 0,
      fillFulfilled: 0,
      filteredReadAttempted: 0,
      filteredReadFulfilled: 0,
      resetFillAttempted: 0,
      resetFillFulfilled: 0,
      resetUrlWaitAttempted: 0,
      resetUrlWaitFulfilled: 0,
      resetUrlReadAttempted: 0,
      resetUrlReadFulfilled: 0,
      resetSentinelWaitAttempted: 0,
      resetSentinelWaitFulfilled: 0,
      resetSentinelReadAttempted: 0,
      resetSentinelReadFulfilled: 0,
      finalReadAttempted: 0,
      finalReadFulfilled: 0,
      baselineReadAttempted: 0,
      baselineReadFulfilled: 0,
    ...
    let result = "V56_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
    let errorClass = "NONE";
    let declarationShape = false;
    ...
    let baselineRowCount = -1;
    let noResultsRowCount = -1;
    let actionResidueCount = -1;
    let queryUrlExact = false;
    ...
    try {
      declarationShape =
        gateWasFresh === true &&
        typeof secureConsoleV56Consumed === "boolean" &&
        typeof secureConsoleV56AttachmentState === "string" &&
        typeof secureConsoleOwnedTaskTabV56Attachment === "object" &&
        typeof secureConsoleOwnedTaskTabV56AttachmentEligible === "boolean" &&
        typeof secureConsoleSetupBrowserRuntimeV56Attachment === "function" &&
        typeof secureConsoleAgentV56Attachment === "object" &&
        secureConsoleAgentV56Attachment !== null &&
        typeof secureConsoleChromeV56Attachment === "object" &&
        secureConsoleChromeV56Attachment !== null &&
        secureConsoleOwnedTaskTabV56 === null &&
        secureConsoleOwnedTaskTabV56Eligible === false &&
        secureConsoleOwnedTaskTabV56State === "UNADOPTED" &&
        ...
        secureConsoleOwnedTaskTabV56PostNativeDetachConsumed === false &&
        secureConsoleCloudflareReadsV56Consumed === false;
      if (!declarationShape) throw new Error("V56DeclarationShapeError");
      predecessorStateExact =
        secureConsoleV56Consumed === true &&
        secureConsoleV56AttachmentState === "V56Attachment_ACCOUNT_HOME_READY_ELIGIBLE" &&
        secureConsoleOwnedTaskTabV56Attachment !== null &&
        secureConsoleOwnedTaskTabV56AttachmentEligible === true;
      if (!predecessorStateExact) throw new Error("V56AttachmentPredecessorStateError");

      counters.bindingAttempted++;
      adopted = secureConsoleOwnedTaskTabV56Attachment;
      ...
      tabShape =
        ...
        typeof adopted.playwright?.locator === "function";
      if (!tabShape) throw new Error("V56AttachmentTabOwnershipError");
      ...
      const tokenFilter =
        adopted.playwright.locator("#user-api-tokens-search");
      ...
      const tokenTable = adopted.playwright.locator("table").filter({
        hasText: /Token name[\s\S]*Permissions[\s\S]*Resources[\s\S]*Last used[\s\S]*Expires[\s\S]*Status/,
      });
      if (await tokenTable.count() !== 1) {
        throw new Error("TokenTableCountError");
      }
      counters.readinessAttempted++;
      await tokenTable.waitFor({ state: "visible", timeoutMs: 20000 });
      counters.readinessFulfilled++;
      counters.initialReadAttempted++;
      const initialFilterState = await tokenFilter.evaluate((input) => ({
        valid: input.tagName === "INPUT" &&
          (input.type === "search" || input.type === "text") &&
          input.disabled === false,
        empty: input.value === "",
      }));
      counters.initialReadFulfilled++;
      if (!initialFilterState.valid) throw new Error("TokenInitialFilterStateError");
      tokenInitialFilterEmpty = initialFilterState.empty;
      if (!tokenInitialFilterEmpty) {
        counters.resetFillAttempted++;
        await tokenFilter.fill("");
      ...
      counters.resetUrlReadFulfilled++;
      if (resetUrl.href !== "https://dash.cloudflare.com/profile/api-tokens") {
        throw new Error("TokenResetUrlError");
      }
      const resetSentinel = tokenTable.getByText(
        "No results found for your search", { exact: true },
      );
      counters.resetSentinelWaitAttempted++;
      await resetSentinel.waitFor({ state: "hidden", timeoutMs: 20000 });
      counters.resetSentinelWaitFulfilled++;
      counters.resetSentinelReadAttempted++;
      noResultsRowCount = await resetSentinel.count();
      counters.resetSentinelReadFulfilled++;
      if (noResultsRowCount > 1) throw new Error("TokenResetSentinelCountError");
      counters.finalReadAttempted++;
      const finalFilterEmpty = await tokenFilter.evaluate((input) => input.value === "");
      counters.finalReadFulfilled++;
      if (!finalFilterEmpty) throw new Error("TokenFinalFilterStateError");
      counters.baselineReadAttempted++;
      const tokenBaseline = await tokenTable.evaluate((table) => {
        const labels = [...table.querySelectorAll("thead tr:first-child th, thead tr:first-child td")]
          .map((item) => (item.textContent || "").replace(/\s+/g, " ").trim());
        const expected = ["Token name", "Permissions", "Resources", "Last used", "Expires", "Status"];
        const rows = [...table.querySelectorAll("tbody tr")];
        const busy = table.matches('[aria-busy="true"]') ||
          table.querySelector('[aria-busy="true"]') !== null;
        const targetCount = [...table.querySelectorAll("tbody td")].filter(
          (item) => (item.textContent || "").replace(/\s+/g, " ").trim() ===
            "OmniRoute secure console R5 20260901",
        ).length;
        return {
          headerExact: expected.every((label, index) => labels[index] === label),
          rowCount: rows.length,
          targetCount,
          ready: !busy && rows.length >= 1 && rows.length <= 1000,
        };
      });
      counters.baselineReadFulfilled++;
      baselineRowCount = tokenBaseline.rowCount;
      if (!tokenBaseline.headerExact || !tokenBaseline.ready ||
          tokenBaseline.targetCount !== 0) {
      ...
      const filteredNoResultsRow = tokenTable.getByText(
        "No results found for your search", { exact: true },
      );
      counters.readinessAttempted++;
      await filteredNoResultsRow.waitFor({ state: "visible", timeoutMs: 20000 });
      counters.readinessFulfilled++;
      noResultsRowCount = await filteredNoResultsRow.count();
      if (noResultsRowCount !== 1) {
        throw new Error("TokenNoResultsCountError");
      }
      const tokenValueExact = await tokenFilter.evaluate(
        (input) => input.value === "OmniRoute secure console R5 20260901",
      );
      counters.urlAttempted++;
      const filteredUrl = new URL(await adopted.url());
      counters.urlFulfilled++;
      queryUrlExact = filteredUrl.protocol === "https:" &&
        filteredUrl.hostname === "dash.cloudflare.com" &&
        filteredUrl.port === "" && filteredUrl.username === "" &&
        filteredUrl.password === "" &&
        filteredUrl.pathname === "/profile/api-tokens" &&
        filteredUrl.hash === "" &&
        [...filteredUrl.searchParams.keys()].length === 1 &&
        filteredUrl.searchParams.get("search") ===
          "OmniRoute secure console R5 20260901";
      counters.filteredReadAttempted++;
      const tokenTerminal = await tokenTable.evaluate((table) => {
        const rows = [...table.querySelectorAll("tbody tr")];
        const normalized = (rows[0]?.textContent || "").replace(/\s+/g, " ").trim();
        const busy = table.matches('[aria-busy="true"]') ||
          table.querySelector('[aria-busy="true"]') !== null;
        const targetCount = [...table.querySelectorAll("tbody td")].filter(
          (item) => (item.textContent || "").replace(/\s+/g, " ").trim() ===
        ...
        const actions = table.querySelectorAll('[aria-label="Actions"]').length;
        return { exact: !busy && rows.length === 1 &&
          normalized === "No results found for your search" &&
          targetCount === 0 && actions === 0, actions };
      });
      counters.filteredReadFulfilled++;
      ...
      matchingRowCount = await tokenTable.getByRole("row").filter({
        hasText: "OmniRoute secure console R5 20260901",
      }).count();
      counters.rowReadFulfilled++;
      tokenFilterComplete =
        finalFilterEmpty && baselineRowCount >= 1 &&
        noResultsRowCount === 1 && tokenValueExact && queryUrlExact &&
        tokenTerminal.exact && actionResidueCount === 0;
      ...
      const exactCounters =
        ...
        counters.urlAttempted === 2 && counters.urlFulfilled === 2 &&
        counters.readinessAttempted === 3 &&
        counters.readinessFulfilled === 3 &&
        counters.initialReadAttempted === 1 &&
        counters.initialReadFulfilled === 1 &&
        counters.resetFillAttempted === (tokenInitialFilterEmpty ? 0 : 1) &&
        counters.resetFillFulfilled === (tokenInitialFilterEmpty ? 0 : 1) &&
        counters.resetUrlWaitAttempted === 1 && counters.resetUrlWaitFulfilled === 1 &&
        counters.resetUrlReadAttempted === 1 && counters.resetUrlReadFulfilled === 1 &&
        counters.resetSentinelWaitAttempted === 1 && counters.resetSentinelWaitFulfilled === 1 &&
        counters.resetSentinelReadAttempted === 1 && counters.resetSentinelReadFulfilled === 1 &&
        counters.finalReadAttempted === 1 && counters.finalReadFulfilled === 1 &&
        counters.baselineReadAttempted === 1 && counters.baselineReadFulfilled === 1 &&
        counters.fillAttempted === 1 && counters.fillFulfilled === 1 &&
        counters.filteredReadAttempted === 1 &&
        counters.filteredReadFulfilled === 1 &&
      ...
      result = "EXACT_V56_TOKEN_PAGE_SEMANTIC_READINESS_PASS";
    } catch {
      errorClass = "Error";
    }

    if (result === "EXACT_V56_TOKEN_PAGE_SEMANTIC_READINESS_PASS") {
      secureConsoleOwnedTaskTabV56 = adopted;
      secureConsoleOwnedTaskTabV56Eligible = true;
      secureConsoleOwnedTaskTabV56Attachment = null;
      secureConsoleOwnedTaskTabV56AttachmentEligible = false;
      secureConsoleV56AttachmentState = "V56Attachment_TRANSFERRED_TO_V56";
      secureConsoleChromeV56Attachment = null;
      secureConsoleAgentV56Attachment = null;
      secureConsoleSetupBrowserRuntimeV56Attachment = null;
      ...
      if (continuationBindingsRetained) {
        ...
        result = "V56_TOKEN_PAGE_SEMANTIC_READINESS_FAILED_STOP";
        errorClass = "Error";
        secureConsoleOwnedTaskTabV56 = null;
        secureConsoleOwnedTaskTabV56Eligible = false;
        secureConsoleOwnedTaskTabV56State =
          "V56_TOKEN_PAGE_SEMANTIC_READINESS_FAILED";
        secureConsoleV56AttachmentState = "V56Attachment_DOWNSTREAM_FAILURE_DETACHED";
        failureCleanupComplete =
          secureConsoleOwnedTaskTabV56 === null &&
          secureConsoleOwnedTaskTabV56Eligible === false &&
          secureConsoleOwnedTaskTabV56Attachment === null &&
    ...
    try {
      await nodeRepl.write({
        ...
        predecessorRuntimeCleared,
        failureCleanupComplete,
        attachment: secureConsoleV56AttachmentEvidence,
        ...counters,
        errorClass,
        consumed: secureConsoleV56Consumed,
        bindingEligible: secureConsoleOwnedTaskTabV56Eligible,
        bindingNull: secureConsoleOwnedTaskTabV56 === null,
        state: secureConsoleOwnedTaskTabV56State,
        predecessorBindingNull: secureConsoleOwnedTaskTabV56Attachment === null,
        predecessorState: secureConsoleV56AttachmentState,
      });
      secureConsoleV56AttachmentEvidence = null;
      secureConsoleV56TerminalOutputFailure = null;
    } catch (terminalError) {
      secureConsoleOwnedTaskTabV56 = null;
      secureConsoleOwnedTaskTabV56Eligible = false;
      secureConsoleOwnedTaskTabV56State = "V56_FINAL_OUTPUT_FAILED_STOP";
      secureConsoleOwnedTaskTabV56Attachment = null;
      secureConsoleOwnedTaskTabV56AttachmentEligible = false;
      secureConsoleV56AttachmentState = "V56Attachment_DOWNSTREAM_OUTPUT_FAILURE_DETACHED";
      secureConsoleChromeV56Attachment = null;
      secureConsoleAgentV56Attachment = null;
      secureConsoleSetupBrowserRuntimeV56Attachment = null;
      secureConsoleV56AttachmentEvidence = null;
