...
Current checkpoint (2026-09-13 Bangkok): 7/12. Provider R1-R5 are spent. R5 proved Q6 HTTP200 generation; Q4 is unavailable at its Cloudflare Tunnel (530/1033), and the last proven qualification-key policy is Q4 singleton. R6 for the remaining eight physical providers plus both aliases is frozen for independent review; it preserves original permissions and corrects the collector's bounded provider-error handling. Native DSH dummy credential handling and actual VM105 no-network containment passed; installed closure and final transport preparation continue. Hermes's prepared immutable-release transaction now includes acceptance before defaults and native secure credential delivery/rollback, pending independent review and final bindings. Fresh topology proves the team proxy uses Docker DNS `omniroute:20128`; a builder-only DNS transfer/rollback rehearsal is prepared for review. Live switching/defaults remain unchanged; the handoff records exact pins and ownership.
...
- Earlier 04dd-based Hermes work is retained unchanged at accepted `aa82b0fb468c4c16956051819d23d4f48d1ebc16`. The latest port is `.worktrees/hermes-auto-switch-live-base-20260912` on verified live base `693641aa8b4359c602283bdbbc14041e03bc47bc`, independently accepted and frozen at `9098efc055a186c862f189022417d9f553b2bee7`. This source acceptance grants no live-client release and does not overwrite VM104.
