...
class Runtime:
    ...
    def snapshot(self):
        return {"candidate": "omniroute-auto-switch-q4-r9-20260915", "isolated": True}
    ...
    def authenticate(self, secret):
        ...
        return {"health_http_status": 200, "models_http_status": 200,
                "completion_http_status": 200, "selected_q4": True,
                "content_valid": True, "request_id": "11111111-1111-4111-8111-111111111111"}
...
class Q4R9Test(unittest.TestCase):
    def test_manifest_approval_and_single_spent_execution_are_bound_to_fresh_files(self):
        ...
        action = {"schema": "auto-switch-q4-r9-action/v1", "source_manifest": manifest,
