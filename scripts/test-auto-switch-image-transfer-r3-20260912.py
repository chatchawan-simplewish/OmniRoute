"""Offline regression checks for R3 remote role elevation and absence proof."""
...
script = pathlib.Path(__file__).with_name("auto-switch-image-transfer-r3-20260912.py")
spec = importlib.util.spec_from_file_location("transfer_r3", script)
